...
menu.urlButton('Planka Web-Site', 'https://planka.store')
...
let isAndroid = true
menu.submenu('Наша Галлерея', 'photo', new TelegrafInlineMenu('', {
  photo: () => isAndroid ? 'https://planka.store/images/detailed/1/MirageT-shirt_Black_1.jpg' : 'https://planka.store/images/thumbnails/800/600/detailed/1/SpottyLeggings_Green_2.jpg'
}))
  .setCommand('photo')
  .simpleButton('Легинсы', 'a', {
